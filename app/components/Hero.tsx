    ...
    >
      <div className="hero__content section-shell">
        <div className="hero__copy">
          ...
          <ul className="hero__licenses" aria-label="Behavior analyst licensure">
            <li>North Carolina</li><li>Virginia</li><li>New York</li>
          </ul>
          <p className="hero__summary">{hero.summary}</p>

          <div className="hero__actions" aria-label="Primary actions">
            <a className="button button--primary" href={publicPath(hero.primaryAction.href)}>
              {hero.primaryAction.label}
            </a>
            <SafeLink className="button button--secondary" href="/resume" newTab>
              View print résumé
            </SafeLink>
            <a className="text-link" href={publicPath(hero.contactAction.href)}>
          ...
          <figure className="hero__portrait">
            <div className="hero__portrait-frame">
              ...
              <img
                ...
                fetchPriority="high"
                height="720"
                src={publicPath("/media/fatgezim-bela-headshot.jpg")}
                width="720"
              />
            </div>
            <figcaption>Clinical care. Data. Human connection.</figcaption>
          </figure>
